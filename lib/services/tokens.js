...
Tokens.prototype.listTokens = function(callback) {
  return this.client({
    path: constants.API_TOKENS_LIST,
    params: {
      owner: this.owner
    },
    callback: callback
...
Tokens.prototype.createToken = function(note, scopes, callback) {
  return this.client({
    path: constants.API_TOKENS_CREATE,
    params: {
      owner: this.owner
    },
    entity: {
...
Tokens.prototype.updateTokenAuthorization = function(authorization_id, scopes, callback) {
  return this.client({
    path: constants.API_TOKENS_UPDATE_AUTHORIZATION,
    params: {
...
Tokens.prototype.deleteTokenAuthorization = function(authorization_id, callback) {
  return this.client({
    path: constants.API_TOKENS_DELETE_AUTHORIZATION,
    params: {
      authorization_id: authorization_id,
      owner: this.owner
    },
...
Tokens.prototype.retrieveToken = function(access_token, callback) {
  return this.client({
    path: constants.API_TOKENS_RETRIEVE,
    params: {
...
Tokens.prototype.listScopes = function(access_token, callback) {
  return this.client({
    path: constants.API_TOKENS_LIST_SCOPES,
    params: {
      access_token: access_token,
      owner: this.owner
    },
