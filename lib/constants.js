...
module.exports.API_TOKENS_LIST = '/tokens/v2/{owner}';
module.exports.API_TOKENS_CREATE = '/tokens/v2/{owner}';
module.exports.API_TOKENS_UPDATE_AUTHORIZATION = '/tokens/v2/{owner}/{authorization_id}';
module.exports.API_TOKENS_DELETE_AUTHORIZATION = '/tokens/v2/{owner}/{authorization_id}';
module.exports.API_TOKENS_RETRIEVE = '/tokens/v2{?access_token}';
module.exports.API_TOKENS_LIST_SCOPES = '/scopes/v1/{owner}';
